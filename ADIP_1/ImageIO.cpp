...
unsigned char* ImageIO::input(const char input_file[], int img_size, int memory_size, FILE* img_file) {
...
void ImageIO::output(const char output_file[], int img_size, int memory_size, FILE* img_file, unsigned char* out_img) {
